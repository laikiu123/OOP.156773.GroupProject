...
public abstract class Student {
    ...
    /**
     * Lấy danh sách môn đã nhập đủ điểm (cả passed và failed),
     * để tính CPA bao gồm cả những môn chưa đạt (điểm tính = 0 nếu <4).
     *
     * @return List of Enrollment đã nhập điểm
     */
    ...
    /**
     * Tính CPA theo hệ tương ứng.
     *
     * @return CPA trên thang 4 hoặc thang 10
     */
