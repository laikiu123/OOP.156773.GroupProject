...
/**
 * Quản lý danh sách học phần (Course).
 * Tự động đồng bộ xóa và cập nhật trong các Program liên quan khi một Course bị xóa hoặc sửa.
 */
public class CourseManager {
     ...
     * @return true nếu thêm thành công; false nếu course null hoặc đã tồn tại (trùng courseID)
     */
    ...
    /**
     * Sửa thông tin Course đã tồn tại.
     * Cascade: cập nhật thay thế instance cũ bằng newCourse trong tất cả Program.
     *
     * @param courseID  Mã học phần cần sửa
     * @param newCourse Đối tượng Course chứa thông tin mới; courseID phải khớp
     * @return true nếu sửa thành công; false nếu không tìm thấy hoặc input không hợp lệ
     */
