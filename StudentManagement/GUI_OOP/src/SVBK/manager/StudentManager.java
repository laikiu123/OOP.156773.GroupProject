...
/**
 * Lớp StudentManager chịu trách nhiệm quản lý danh sách sinh viên: thêm, xóa,
 * tìm kiếm, sửa thông tin sinh viên, và đăng ký học phần.
 */
public class StudentManager {
	 ...
	 * @return true nếu đăng ký thành công; false nếu không tìm thấy SV hoặc khóa đã
	 *         đăng ký
	 */
	 ...
	 * @return true nếu thêm thành công; false nếu student null hoặc đã tồn tại
	 *         (trùng studentID).
	 */
	 ...
	 * @return true nếu xóa thành công; false nếu không tìm thấy studentID.
	 */
	 ...
	 * @return đối tượng Student nếu tìm thấy; null nếu studentID null hoặc không
	 *         tồn tại.
	 */
	 ...
	 * @param newData   Đối tượng Student chứa thông tin mới; studentID phải khớp
	 *                  với mã cũ.
	 * @return true nếu sửa thành công; false nếu newData null, mã không khớp hoặc
	 *         không tìm thấy.
	 */
