...
/**
 * Quản lý danh sách chương trình đào tạo (Program). Cho phép thêm, xóa, tìm
 * kiếm và chỉnh sửa chương trình.
 */
public class ProgramManager {
	 ...
	 * @return true nếu thêm thành công; false nếu program null hoặc đã tồn tại
	 *         (trùng majorName)
	 */
	 ...
	 * @return true nếu cập nhật thành công; false nếu không tìm thấy hoặc input
	 *         không hợp lệ
	 */
