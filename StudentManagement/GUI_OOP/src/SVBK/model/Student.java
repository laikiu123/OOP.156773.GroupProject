 ...
 * Thông tin ngành được lưu trong {@link Program}, không lặp lại ở đây. Quản lý
 * danh sách Enrollment chứa các học phần đang học và đã hoàn thành.
 */
public abstract class Student {
	...
	/**
	 * Đăng ký học phần nếu: 1) Course != null 2) Chưa đăng ký/chưa hoàn thành trước
	 * đó 3) Nếu course có prerequisite thì student đã hoàn thành khóa prerequisite
	 *
	...
	/**
	 * Lấy danh sách môn đang học (chưa pass): - Không nhập đủ điểm, hoặc đã nhập
	 * nhưng điểm < 4.0.
	 *
	...
	public String toString() {
		return String.format("%s - %s [%s]\n  Đang học: %s\n  Đã hoàn thành: %s", studentID, studentName, studentType,
