...
/**
 * Sinh viên hệ niên chế (Part-time), tính CPA thang 10. Sử dụng enrollments từ
 * lớp cha để quản lý đăng ký môn và điểm.
 */
public class PartTimeStudent extends Student {
	...
	/**
	 * Đăng ký học phần (Enrollment) cho sinh viên niên chế. Chỉ cho phép các học
	 * phần bắt buộc thuộc chương trình.
	 *
	 * @param course Học phần cần đăng ký
	 * @return true nếu đăng ký thành công; false nếu course null, không thuộc
	 *         requiredCourses hoặc đã đăng ký trước đó.
	 */
	...
	/**
	 * Tính điểm trung bình (CPA) theo thang 10 dựa trên các Enrollment đã hoàn
	 * thành của những Course nằm trong requiredCourses.
	 *
	...
	/**
	 * Kiểm tra điều kiện tốt nghiệp: - Hoàn thành tất cả requiredCourses - CPA
	 * thang 10 >= 5.0
	 *
