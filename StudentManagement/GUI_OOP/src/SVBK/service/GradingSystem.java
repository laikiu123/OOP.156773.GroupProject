...
/**
 * Nhập điểm và tính CPA cho sinh viên. Điểm nhập luôn theo thang 10 cho cả
 * Credit-based và Part-time.
 */
public class GradingSystem {
	/**
	 * Nhập điểm giữa kỳ và cuối kỳ (thang 10) cho sinh viên. Chỉ nhập cho các học
	 * phần đã đăng ký (Enrollment chưa hoàn thành).
	 *
	 ...
	 * @return true nếu điểm hợp lệ và nhập thành công; false nếu không phù hợp hoặc
	 *         không có Enrollment
	 */
