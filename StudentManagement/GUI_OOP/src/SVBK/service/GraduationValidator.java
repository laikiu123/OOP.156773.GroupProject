...
public class GraduationValidator {
	...
	/**
	 * Phân loại học lực: - PartTimeStudent (thang 10): [9.0–10]: Xuất sắc;
	 * [8.0–<9.0]: Giỏi; [7.0–<8.0]: Khá; [5.0–<7.0]: Trung bình; [4.0–<5.0]: Yếu;
	 * <4.0: Kém. - CreditBasedStudent (thang 4): [3.6–4.0]: Xuất sắc; [3.2–<3.6]:
	 * Giỏi; [2.5–<3.2]: Khá; [2.0–<2.5]: Trung bình; [1.0–<2.0]: Yếu; <1.0: Kém.
	 *
	 * @param student Đối tượng Student
